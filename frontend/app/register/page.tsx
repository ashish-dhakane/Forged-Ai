...
// User registration page to create a new engineering profile on ForgeAI.
import React, { useState } from 'react';
import Link from 'next/link';
import { Sparkles, AlertCircle, ArrowRight, Lock, Mail, User as UserIcon, Github } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  // Submits registration payload to the Spring Boot /api/auth/register endpoint.
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        ...
        <h2 className="mt-4 text-xl font-semibold text-slate-100">Create your engineering account</h2>
        <p className="mt-1 text-xs text-slate-400">Join ForgeAI to benchmark your skills against industry standards</p>
      </div>
        ...
        <div className="bg-slate-900 border border-slate-800 py-8 px-6 shadow-xl rounded-2xl sm:px-10">
          ...
          <div className="mb-6 p-4 rounded-xl bg-amber-500/10 border border-amber-500/30 text-left">
            <span className="text-xs font-semibold text-amber-300 flex items-center gap-1.5">
              ...
              University Viva Evaluation
            </span>
            <p className="text-[11px] text-slate-300 mt-1">
              Want to inspect the fully populated platform immediately?
            </p>
            <button
              type="button"
              onClick={() => loginDemo()}
            ...
            >
              <span>Instant Login as Demo Engineer</span>
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-slate-900 px-3 text-slate-400 font-mono">Or register new profile</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-3.5">
            ...
            <div>
              <label className="block text-xs font-medium text-slate-300 mb-1">GitHub Username (Optional)</label>
              <div className="relative">
            ...
            <button
              ...
              className="w-full mt-2 py-2.5 px-4 rounded-lg bg-blue-600 hover:bg-blue-500 text-white font-medium text-sm transition-colors flex items-center justify-center gap-2 shadow-sm disabled:opacity-50"
            >
